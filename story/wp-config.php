 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'Ns|l2I&T6`A/e;0Qe`5t^b0*G):E0xq>&/e$+ied:A0)cJ&nQ/:!sFjRWi|sK(6r');
define('SECURE_AUTH_KEY',  'cWZ*Hy0A+*sn>cgNI|3h&F%L1TRR,>3WoAFYx^|r/wy42p`JJ;UgIT1&vXHuGdR*');
define('LOGGED_IN_KEY',    '0&H4 zqo1-n-i`G%$PQ{K&$%k@+H1XJX.+3d}O;D*I<=hn]1pYRl)Mr9Y:+-2zHv');
define('NONCE_KEY',        'EqP4L7{NV@FqG-+o40XgVIQKl.v_4vGrYr6kn1W1ZLWOt5NG=v[w~NoA,$+~0+Af');
define('AUTH_SALT',        '&m<v@r}i9d1:_r_LW0P8-V|s04pR5@s$%G^ak|f3<,2m]wFm7-ut7^{2I1zrx6)|');
define('SECURE_AUTH_SALT', 'F?*s}Zx#7}}3W+yt9q_#8!)G*PJw^IU(q=_d:a0_-V$!u6*x)-P+K)B!{Pz4ER&z');
define('LOGGED_IN_SALT',   'vcFx_nPf;d,ML j8nhq*%}>6|hQHWQOg*I_O.F[jRUpUrb]X;SQ<cZ!SAN8|az4P');
define('NONCE_SALT',       '}3T3 [=mFWaz?(d:w`4Ygf`.L2%ptBN1|!J1-K#JD $Y5ULy7l)}r>tVZO!ZD90>');
